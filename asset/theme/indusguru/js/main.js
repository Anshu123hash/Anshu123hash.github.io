    ...
    * ------------------------------------------------------ */
    var clSlickSlider = function() {
        ...
        $('.clients').slick({
            ...
            dots: true,
            infinite: true,
            slidesToShow: 4, // Default setting for large screens
            ...
            responsive: [
                {
                    ...
                    settings: {
                        slidesToShow: 4, // Show only 3 slides
                        slidesToScroll: 1
                    }
                },
                {
                    ...
                    settings: {
                        slidesToShow: 4, // Consistent behavior across breakpoints
                        slidesToScroll: 1
                    }
                },
                {
                    breakpoint: 800, // For screens smaller than 800px
                    settings: {
                ...
                },
                {
                    ...
                    settings: {
                        slidesToShow: 2, // Show only 1 slide on very small screens
                        slidesToScroll: 1
                    }
                }
            ]
        ...
        $('.clients2').slick({
            ...
            responsive: [
                ...
                },
                {
                    breakpoint: 1000, // For screens smaller than 1000px
                    settings: {
                        slidesToShow: 3, // Consistent behavior across breakpoints
                        slidesToScroll: 1
                    }
                },
                {
                    breakpoint: 800, // For screens smaller than 800px
                    settings: {
                        slidesToShow: 1, // Show 2 slides for smaller screens
                        slidesToScroll: 1
                    }
                },
                {
